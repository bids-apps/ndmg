...
RUN pip install cython numpy coveralls wget nibabel nilearn dipy sklearn networkx awscli boto3 plotly python-dateutil==2.5 requests==2.5.3
RUN pip install ndmg==0.0.43-1
